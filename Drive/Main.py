...
import os
import argparse
from utils.utils import Getmeanstd,Generate_Txt
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--Tr_Image_dir",
        default="Data/DRIVE/Image_Tr/",
        help="the address of the train image",
    )
    parser.add_argument(
        "--Te_Image_dir",
        default="Data/DRIVE/Image_Te/",
        help="the address of the test image",
    )
    parser.add_argument(
        "--Tr_Label_dir",
        default="Data/DRIVE/Label_Tr/",
        help="the address of the train label",
    )
    parser.add_argument(
        "--Te_Label_dir",
        default="Data/DRIVE/Label_Te/",
    ...
    parser.add_argument("--Dir_Txt",
                        default="Txt/Txt_DRIVE/",
                        help="Txt path")
    parser.add_argument("--Dir_Save",
                        default="Results/DRIVE/",
                        help="Save path")
    parser.add_argument("--Dir_Weights",
                        default="Weights/DRIVE/",
                        help="Weights path")

    # Folders, dataset, etc.
    parser.add_argument(
        "--Image_Tr_txt",
        default="Txt/Txt_DRIVE/Image_Tr.txt",
        help="train image txt path",
    )
    parser.add_argument(
        "--Image_Te_txt",
        default="Txt/Txt_DRIVE/Image_Te.txt",
        help="test image txt path",
    )
    parser.add_argument(
        "--Label_Tr_txt",
        default="Txt/Txt_DRIVE/Label_Tr.txt",
        help="train label txt path",
    )
    parser.add_argument(
        "--Label_Te_txt",
        default= "Txt/Txt_DRIVE/Label_Te.txt",
    ...
    parser.add_argument("--save_path",
                        default="Results/DRIVE/DSCNet/",
                        help="Save dir")
    parser.add_argument(
        "--save_path_max",
        default="Results/DRIVE/DSCNet_max/",
        help="Save max dir",
    )
    ...
    parser.add_argument("--n_epochs", default=3, type=int, help="Epoch Num")
